...
public class ChangeLoader implements Callable<Long> {
  ...
  private Logger logger = LogManager.getLogger("Dbsync." + ChangeLoader.class);
   ...
   */
  protected LoadTask pollTask() throws InterruptedException, DbsyncException {
    LoadTask task = null;
    ...
    while (!cxt.stop) {
      ...
      if (head != null && head.isDone()) {
        ...
        try {
          ...
          throw new DbsyncException(e.getCause());
        }
   ...
   * @throws DbsyncException - wrap and throw Exception which cannot be handled
   */
  protected void getConnection() throws InterruptedException, DbsyncException {
    do {
   ...
   * @throws DbsyncException - Wrap and throw Exception which cannot be handled
   */
  protected void executeTask() throws InterruptedException, DbsyncException {
  ...
  private Long executeDelete(Set<String> delete) throws DbsyncException, InterruptedException {
    long deleteCounts;
  ...
  private void executeInsert(Set<String> insertSet) throws DbsyncException, InterruptedException {
  ...
  private Long copyWorker(String tableName, ArrayList<String> columnList, Set<String> tuples)
      throws DbsyncException, InterruptedException {
  ...
  private void tupleWriter(PipedOutputStream pipeOut, Set<String> tuples) throws DbsyncException {
    byte[] data = null;
  ...
  private void createTemporaryTable() throws DbsyncException {
