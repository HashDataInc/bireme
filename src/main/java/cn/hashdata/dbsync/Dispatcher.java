...
public class Dispatcher implements Callable<Long> {
  ...
  private Logger logger = LogManager.getLogger("Dbsync." + Dispatcher.class);
  ...
  private void dispatch(ChangeSet changeSet) throws DbsyncException, InterruptedException {
  ...
  private void checkTansformResults() throws DbsyncException, InterruptedException {
    RowSet rowSet = null;
